...
Exploratory and tutorial notebooks kept for reference. These are **not** part
of the reproducible pipeline and may reference data files or local paths that
are not in this repository (e.g., the original `batram` tutorial datasets).
